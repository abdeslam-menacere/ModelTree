...
const CHECKS = [
  ...
  },
  {
    ...
    commands: [
      ...
      {
        label: 'Refuse a test file that no registry runs',
        cwd: '.',
        bin: 'node',
        args: ['.github/scripts/check-test-registries.mjs'],
      },
      {
        label: 'Pin the test registry guard',
        cwd: '.',
        bin: 'node',
        args: ['--test', '.github/scripts/check-test-registries.test.mjs'],
      },
      {
        label: 'Run the scout bundle-pairing tests',
        cwd: '.',
        bin: 'node',
        args: ['--test', '.github/skills/modeltree-scout/tests/check-bundle-pairing.test.mjs'],
      },
    ],
    requires: [],
  },
